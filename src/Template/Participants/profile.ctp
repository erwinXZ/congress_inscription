        ...
        <div class="col-md-offset-3 col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <a href="<?php echo $this->Url->build('/certificate/' . $participant->id); ?>" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-certificate"></i> <b>Ver Certificado</b></a>
                    <?php } else { ?>
